...
public class TransaccionesCuenta extends javax.swing.JFrame {
    ...
    private void llenarTransacciones(){
        ...
        while(!transacc.isEmpty() && cont>0){
            modelo.addElement(transacc.get(0));
            transacc.remove(0);
            cont--;
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ultimas 20 transacciones realizadas: ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransaccionesCuenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransaccionesCuenta().setVisible(true);
            }
        });
    }
